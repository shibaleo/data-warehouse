#!/usr/bin/env python3
"""Migrate Tanita Health Planet raw data from Supabase to Neon.

Usage:
    python migrations/migrate_tanita_data_supabase_to_neon.py
"""
...
TABLES = [
    ('raw.tanita_health_planet__body_composition', 'data_warehouse.raw_tanita_health_planet__body_composition'),
    ('raw.tanita_health_planet__blood_pressure',   'data_warehouse.raw_tanita_health_planet__blood_pressure'),
]
