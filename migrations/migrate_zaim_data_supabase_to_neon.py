#!/usr/bin/env python3
"""Migrate Zaim raw data from Supabase to Neon.

Usage:
    python migrations/migrate_zaim_data_supabase_to_neon.py
"""
...
TABLES = [
    ('raw.zaim__money',    'data_warehouse.raw_zaim__money'),
    ('raw.zaim__category', 'data_warehouse.raw_zaim__category'),
    ('raw.zaim__genre',    'data_warehouse.raw_zaim__genre'),
    ('raw.zaim__account',  'data_warehouse.raw_zaim__account'),
]
